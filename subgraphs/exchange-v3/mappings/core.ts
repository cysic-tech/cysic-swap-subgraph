...
export function handleMint(event: MintEvent): void {
  ...
  log.info('Lower Tick ID: {}, poolAddess: {}', [lowerTickId.toString(), poolAddress.toString()]);
  log.info('Upper Tick ID: {}, poolAddess: {}', [upperTickId.toString(), poolAddress.toString()]);
